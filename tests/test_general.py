...
@pytest.mark.parametrize(
    ...
    (g.BroadcastMsg                        , {'broadcast' : g.Broadcast(serial='12345678901234', ip_range=0) ,                                                                                                                              #serial,                     ip_range, reserved, device_type, reserved           crc
                                            'dev_type'  : g.DeviceType.MID_40}                                                     , cmd_payload('aa     01                2200    02        0000  0000      00       00                   3132333435363738393031323334 00        00        01           0000               00000000')),
    ...
    (g.QueryDeviceInformationResponse      , {'is_error': False, 'firmware_version' : (0x11, 0x22, 0x33, 0x44)}                   , cmd_payload('aa     01                1400    01        0000  0000      00       02         00         11223344                                00000000')),
                                                                                                                                                                                                                                #
