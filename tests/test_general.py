...
@pytest.mark.parametrize(
    ...
    (g.ConfigureStaticDynamicIp            , {'is_static': True,  'ip':'192.168.1.1', 
                                            'device_type': DeviceType.MID_40,
                                             'device_version': (1,1,11,11)}                                           , cmd_payload('aa     01                1400    00        0000  0000      00       08         01          c0a80101                               00000000')),
                                                                                                                                                                                                                                #is_error
    ...
    (g.GetDeviceIpInformationResponse      ,{'is_error': False, 'is_static': True, 'ip':'192.168.1.1',
                                            'mask':'255.255.255.0', 'gw':'192.168.1.1',}                                                                                                                                  , cmd_payload('aa     01                1d00    01        0000  0000      00       09         00         01       c0a80101 ffffff00  c0a80101    00000000')),
