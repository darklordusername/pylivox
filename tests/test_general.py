...
@pytest.mark.parametrize(
    ...
    #                                                                                                                                                                                                                             #
    # (g.QueryDeviceInformationResponse      , {'result'    : True, 'firmware_version' : 12}                                        , cmd_payload('aa     01                0000    01        0000  0000      00       01                                                                00000000')),
    #                                                                                                                                                                                                                             #
    # (g.Heartbeat                           , {}                                                                                   , cmd_payload('aa     01                0000    01        0000  0000      00       01                                                                00000000')),
    #                                                                                                                                                                                                                             #return code, work_state, feature_msg, ack_msg
    # (g.HeartbeatResponse                   , { }                                                                                  , cmd_payload('aa     01                0000    01        0000  0000      00       01             00            00          00           00          00000000')),
    #                                                                                                                                                                                                                             #sample_ctrl
    # (g.StartStopSampling                   , {}                                                                                   , cmd_payload('aa     01                0000    01        0000  0000      00       01             00                                                 00000000')),
    #                                                                                                                                                                                                                             #ret_code
    # (g.StartStopSamplingResponse           , {}                                                                                   , cmd_payload('aa     01                0000    01        0000  0000      00       01             00                                                 00000000')),
    #                                                                                                                                                                                                                             #coordinate_type
    # (g.ChangeCoordinateSystem              , {}                                                                                   , cmd_payload('aa     01                0000    01        0000  0000      00       01             00                                                 00000000')),
    #                                                                                                                                                                                                                             #ret_code
    # (g.ChangeCoordinateSystemResponse      , {}                                                                                   , cmd_payload('aa     01                0000    01        0000  0000      00       01             00                                                 00000000')),
    #                                                                                                                                                                                                                             #
