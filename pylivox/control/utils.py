...
TypeDict = {
    ...
    (Frame.Set.GENERAL.value, Frame.Type.CMD.value, Frame.SetGeneral.PUSH_ABNORMAL_STATUS_INFORMATION .value) : general.PushAbnormalStatusInformation,
    ...
    # (Frame.Set.GENERAL.value, Frame.Type.AKN.value, Frame.SetGeneral.PUSH_ABNORMAL_STATUS_INFORMATION .value) : general.PushAbnormalStatusInformationResponse,
